                ...
                <div class="row">
                    <div id="footer" class="col-md-12 footer">
                        <ul>
                            <li class="developer text-center"><a href="http://jamesdriscoll.xyz" target="_blank">Developed by James Driscoll</a></li>
                            <li class="text-center"><a href="http://mattlee.graphics/" target="_blank">Logo design by Matt Lee</a></li>
                            <li class="copy text-right"><span>Copyright &copy; Thomas Line 2017</span></li>
                        </ul>
                    </div>
                </div>
                <!-- / Footer -->
